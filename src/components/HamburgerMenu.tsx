  ...
  return (
    <div className="lg:hidden md:hidden relative w-full">
      <div className="flex flex-1 justify-end">
        ...
        >
          <span
            className={`h-[2px] w-5 rounded-md bg-[#292D32] transition-transform duration-300 ${
              isOpen ? "translate-y-[6px] rotate-45" : ""
            }`}
          ></span>

          <span
            className={`h-[2px] w-5 rounded-md bg-[#292D32] transition-opacity duration-300 ${
      ...
      >
        <nav className="flex flex-col h-full items-center justify-between mt-10">
