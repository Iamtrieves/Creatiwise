...
import SecondPortfolioBgImage from "../assets/images/Portfolio Section Images/portfolio2Image.svg";
import CaretRightIcon from "../assets/images/Portfolio Section Images/CaretRightIcon.svg";

const PortfolioSection: React.FC = () => {
  return (
    <section className="bg-[#D9D9D9] lg:py-[6rem] md:py-[6rem] py-[2rem]">
      <section className="lg:px-[2.8rem] md:px-[2.8rem] px-[1rem]">
        <div>
      ...
      <section className="px-[.3rem]">
        <div className="mt-[1.9375rem] lg:hidden md:hidden block">
          <div className="size-full  z-10">
            <img
              ...
              src={SecondPortfolioBgImage}
              alt=""
            />
          </div>
          <div className="bg-white flex flex-col gap-[2.625rem] shadow-xl rounded-b-xl mx-[5%] mt-[-9%] lg:px-[6.375rem] md:px-[5rem] px-[1rem] md:py-[4rem] py-[2rem] lg:py-[6rem]">
            <div className="flex justify-between items-center">
              <div className="font-semibold lg:text-[2.5rem] md:text-[2rem] text-[1rem]">
                Mr Vase
              </div>
        ...
        <div className="mx-[1.3rem] lg:hidden md:hidden flex justify-end mt-[1.6875rem]">
          <div>
            <Button
              text="See All >>"
