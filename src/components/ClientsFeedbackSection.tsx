...
const ClientsFeedbackSection: React.FC = () => {
  return (
    <div className="bg-white px-[1.2rem] py-[7.3125rem] md:px-[3.7rem] lg:px-[3.7rem]">
      <section className="flex flex-col gap-4">
          ...
          <section className="flex relative flex-col justify-center items-center mt-[6.625rem]">
            ...
            <div className="bg-[#E6E6E6] flex flex-col justify-center items-center pt-[5.0625rem] rounded-xl shadow-xl px-[1rem] pb-[1.625rem]">
              ...
              <p className="text-justify">
                Creatiwise crafted an outstanding brand identity for our
                company, significantly benefiting us and making our brand stand
                out. We look forward to continuing our collaboration with them.
              </p>
            </div>
          </section>
        ...
        <div className="flex justify-end">
          <div>
            <Button
              text="Next >"
              className="text-white bg-black py-2 px-[2rem] lg:px-[3rem] rounded-[3rem] text-center font-medium text-[100%]"
            />
          </div>
        </div>
      </section>
